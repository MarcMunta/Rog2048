      ...
      <section class="screen-inner rest-shell">
        ...
        <div class="top-actions">
          <div>
            ...
            <h2>Elige una accion</h2>
          </div>
        </div>
        <div class="card-grid">
          <button class="rest-card" data-action="heal"><span class="choice-icon">${iconSvg('hp')}</span><strong>Reposar</strong><span>Cura 35% de tu vida maxima.</span></button>
          ...
          <button class="rest-card" data-action="maxhp"><span class="choice-icon">${iconSvg('heart')}</span><strong>Marcar piel</strong><span>Gana +4 vida maxima.</span></button>
        </div>
      </section>
    </main>`);
